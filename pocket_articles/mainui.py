...
class Ui_MainUI(object):
    def setupUi(self, MainUI):
        ...
        self.actionNewDBPocket = QtWidgets.QAction(MainUI)
    ...
    def retranslateUi(self, MainUI):
        ...
        self.actionNewDBPocket.setText(_translate("MainUI", "Новая БД Pocket"))
        self.actionNewDBPocket.setStatusTip(_translate("MainUI", "Создать новую базу данных используя Pocket"))
